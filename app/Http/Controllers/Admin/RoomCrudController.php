...
class RoomCrudController extends CrudController
{
    ...
    protected function setupShowOperation()
    {
        ...
        CRUD::column('owner_id')->type('number');
        CRUD::column('quest_id')->type('number');
        CRUD::column('max_participants')->type('number');
        CRUD::column('status')->type('enum');
        CRUD::column('duration')->type('number');
    }
...
//        CRUD::setFromDb(); // set fields from db columns.
        ...
        CRUD::field('max_participants')->type('number');
        CRUD::field('status')->type('enum');
        CRUD::field('duration')->type('number');
